...
var Animate = class {
  advance(e3) {
    ...
    let i2 = false;
    if (this.lerp)
      this.value = (s2 = this.value, o3 = this.to, n3 = 60 * this.lerp, r3 = e3, function(t3, e4, i3) {
...
function clsx() {
  for (var e3, t3, f3 = 0, n3 = "", o3 = arguments.length; f3 < o3; f3++)
    (e3 = arguments[f3]) && (t3 = r2(e3)) && (n3 && (n3 += " "), n3 += t3);
  return n3;
}
...
var y2 = (0, import_react3.forwardRef)((o3, a3) => {
  var { children: f3, root: p2 = false, options: b3 = {}, autoRaf: y3 = true, rafPriority: v = 0, className: O } = o3, g2 = function(r3, e3) {
    var t3 = {};
    for (var n3 in r3)
      Object.prototype.hasOwnProperty.call(r3, n3) && e3.indexOf(n3) < 0 && (t3[n3] = r3[n3]);
    if (null != r3 && "function" == typeof Object.getOwnPropertySymbols) {
      var o4 = 0;
      for (n3 = Object.getOwnPropertySymbols(r3); o4 < n3.length; o4++)
        e3.indexOf(n3[o4]) < 0 && Object.prototype.propertyIsEnumerable.call(r3, n3[o4]) && (t3[n3[o4]] = r3[n3[o4]]);
    }
    return t3;
