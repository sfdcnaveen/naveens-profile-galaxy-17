...
export default function SocialLinks({ settings }: SocialLinksProps) {
    const linkedinUrl = settings?.LinkedIn_URL__c;
    const githubUrl = settings?.GitHub_URL__c;

    // We no longer display raw URLs, so we don't need formatUrlDisplay
            ...
            {linkedinUrl && (
                <li
                    style={{
                        display: 'flex',
                        flexDirection: 'column',
                        paddingBottom: 'var(--slds-g-spacing-small)',
