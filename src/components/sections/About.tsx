        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-card rounded-2xl p-6 interactive-card glass-hover">
            ...
            <p className="text-muted-foreground mb-4">
              SDET at TestVagrant Technologies (July 2025 - Present): Automating
              Salesforce applications with Playwright and JavaScript, including
              API automation. Previously Consultant and Associate Consultant at
              Capgemini, specializing in Salesforce QA, manual and automated
              testing, defect management, and team collaboration.
            </p>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                ...
                <span>
                  SDET at TestVagrant Technologies (July 2025 - Present)
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span>Consultant at Capgemini (2023 - 2025)</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="h-5 w-5 text-primary mr-2 mt-0.5 flex-shrink-0"
          ...
          <div className="glass-card rounded-2xl p-6 interactive-card glass-hover">
            ...
            <p className="text-muted-foreground">
              Specialized in Electronics and Communication Engineering, building
              a strong foundation in technical problem-solving and analytical
              thinking.
            </p>
          </div>
          ...
          <div className="glass-card rounded-2xl p-6 interactive-card glass-hover">
            ...
            <p className="text-muted-foreground mb-4">
              I specialize in Salesforce development and implementation,
              focusing on creating innovative solutions that drive business
              value.
            </p>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
        ...
        <div className="mt-16 text-center">
          <div className="glass-dark rounded-xl inline-block px-6 py-3 mx-auto">
            <p className="text-lg italic text-muted-foreground">
              "I strive to create value and impact within organizations through
              innovative solutions, effective communication, and technical
              excellence."
            </p>
          </div>
        </div>
