  ...
  const errorContent = (
    <div className="flex flex-col items-center justify-center h-[50vh] text-center p-4 w-full">
      ...
      <button
        ...
        className="inline-flex items-center px-4 py-2 rounded-md border border-primary/20 bg-primary/10 hover:bg-primary/20 text-primary text-sm font-medium transition-all duration-200 glass-hover"
      >
    ...
    <div className="flex items-center justify-between w-full glass-card rounded-full p-2">
      <div className="flex items-center space-x-2">
        <button
          ...
          className={cn(
            "w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 glass-hover",
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          onClick={openInNewTab}
          className="inline-flex items-center px-3 py-1.5 rounded-full border border-primary/20 bg-primary/10 hover:bg-primary/20 text-primary text-sm font-medium transition-all duration-200 glass-hover ml-2"
        >
          <Download className="h-4 w-4 mr-2" />
          Open in New Tab
        </button>
