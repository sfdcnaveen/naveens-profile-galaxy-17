...
const ChatBot = ({ className }: ChatBotProps) => {
  ...
  >([
    {
      text: "👋 Hi there! I'm Naveen's virtual assistant. You can send me a message, and I'll forward it directly to Naveen's WhatsApp for a quick response.",
      sender: "bot",
    },
  ]);
  ...
  const whatsappNumber = "+918500070061"; // Replace with your actual number
